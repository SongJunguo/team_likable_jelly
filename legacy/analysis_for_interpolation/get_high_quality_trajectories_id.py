...
def analyze_high_quality_trajectories():
    ...
    # 读取分析结果
    parquet_path = '/workspace/aircraft_trajectory/team_likable_jelly/legacy/analysis_for_interpolation/full_365_analysis_output_v2/trajectory_analysis.parquet'
